...
//	}
	...
	protected File file(File base, String... parts) {
		...
		String code = Expander.expand(entity, true);

		Files.write(code, output, Charsets.UTF_8);
	}

	
	protected void expand(Collection<Entity> items, boolean doLookup) throws IOException {
		expand(outputPath, items, doLookup);
	}
	
	protected void expand(File outputPath, Collection<Entity> items, boolean doLookup) throws IOException {
